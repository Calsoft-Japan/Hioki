report 50001 "Commercial Invoice"
{
    Caption = 'Commercial Invoice';
    DefaultLayout = RDLC;
    RDLCLayout = './RDLC/CommercialInvoice.rdlc';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(AmountLbl; FieldCaption("Amount"))
                {
                }
                ...
                column(Quantity; FormattedQuantity)
                {
                }
                ...
                column(UnitPriceLbl; 'Price')
                {
                }
                column(UnitOfMeasure; "Unit of Measure")
                {
                }
                column(UnitOfMeasureLbl; FieldCaption("Unit of Measure"))
                {
                }
            ...
            dataitem(Totals; "Integer")
            {
                ...
                column(TotalQuantity; Format(TotalQuantity, 0))
                {
                }
            ...
            begin
                ...
                if PurchInvHeader.FindFirst() then begin
                    PurchaseInformation := PurchInvHeader."Vendor Invoice No." + '/' + PurchInvHeader."Order No.";
                    if not PurchaseNo.Contains(PurchaseInformation) then begin
                ...
                foreach str in PurchaseNo do begin
                    if PurchaseOrderInformation <> '' then
                        PurchaseOrderInformation += char10 + str
                    else
...
#pragma warning restore AA0074
    ...
    protected var
        ...
        PurchaseOrderInformation: Text[100];
